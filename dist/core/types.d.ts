...
export type ChangeCategory = 'feature' | 'bugfix' | 'refactor' | 'docs' | 'test' | 'config' | 'dependency' | 'schema' | 'api' | 'security' | 'performance' | 'breaking' | 'unknown';
...
export type KnowledgeCategory = 'context-engineering' | 'memory-systems' | 'ai-coding-agents' | 'repository-intelligence' | 'agent-architecture' | 'benchmark-results' | 'lesson-learned' | 'architectural-pattern';
